...
class _Painter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    double rootDx = avatarRoot!.width / 1.6;
    if (textDirection == TextDirection.rtl) rootDx *= -1;
    path.moveTo(rootDx, 0);
    // canvas.drawLine(Offset(rootDx, 20),Offset(rootDx*9, 20) , _paint);
    path.conicTo(rootDx, avatarChild!.height / 2,
        rootDx + avatarChild!.height / 4, avatarChild!.height / 2, 4);
